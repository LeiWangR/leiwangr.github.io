...
<table style="width:100%" border="1px solid black;">
  ...
  <tr>
    <td><strong><font color="green">TIME 2026</font></strong>: 2nd International Workshop on <strong><font color="green">T</font></strong>ransformative <strong><font color="green">I</font></strong>nsights in <strong><font color="green">M</font></strong>ulti-faceted <strong><font color="green">E</font></strong>valuation<br><a href="https://time.griffith.edu.au/workshop/time2026/">[Homepage link]</a></td>
    <td>Dr Lei Wang, Dr Md Zakir Hossain, Prof Tom Gedeon, Dr Zicheng Pan, Dr Syed Islam, Prof Rafiqul Islam, Dr Yasmeen George, Dr Shreya Ghosh</td>
    <td>This new workshop focuses on cross-domain knowledge exchange and adaptation, aiming to bridge successful methodologies across diverse fields. Additionally, it seeks to close the gap between academic research and industry needs. Our discussions will cover the past, present, and future directions of research in web technologies. <br><a href="https://leiwangr.github.io/files/time26-workshop.pdf">[Call for paper submission]</a><a href="https://leiwangr.github.io/files/time26.pdf">[Workshop summary]</a></td>
...
13 April - 17 April 2026</td>
  ...
  <tr>
    ...
    <td>This new workshop focuses on cross-domain knowledge exchange and adaptation, aiming to bridge successful methodologies across diverse fields. Additionally, it seeks to close the gap between academic research and industry needs. Our discussions will cover the past, present, and future directions of research in web technologies. <br><a href="https://leiwangr.github.io/files/time25-workshop.pdf">[Call for paper submission]</a><a href="https://leiwangr.github.io/files/time2025.pdf">[Workshop summary]</a> </td>
...
* **Journals**:
  * IEEE Transactions on Pattern Analysis and Machine Intelligence (TPAMI) ([2025 TPAMI <strong><font color="red">Peer Reviewer</font></strong>](https://leiwangr.github.io/files/tpami-reviewer-certificate.pdf)), International Journal of Computer Vision (IJCV), IEEE Transactions on Image Processing (TIP), ACM Computing Surveys (ACM CSUR), 
  * IEEE Transactions on Circuits and Systems for Video Technology (TCSVT), IEEE Transactions on Industrial Informatics (TII), IEEE Transactions on Multimedia (T-MM), IEEE Transactions on Neural Networks and Learning Systems (TNNLS), IEEE Transactions on Information Forensics and Security (TIFS), IEEE Transactions on Knowledge and Data Engineering (TKDE), IEEE Transactions on Systems, Man and Cybernetics: Systems, IEEE Transactions on Consumer Electronics (TCE), Pattern Recognition (PR), TVCG, Expert Systems With Applications (ESWA), Big Data Mining and Analytics (BDMA), Computer Vision and Image Understanding (CVIU), Neurocomputing, Machine Learning ([certificate](https://leiwangr.github.io/files/machine-learning-certificate.pdf)), ACM Transactions on Multimedia Computing, Communications, and Applications (TOMM), Machine Intelligence Research (MIR), IEEE Signal Processing Letters, Computer Communications, IEEE Access ([2025 IEEE Access <strong><font color="red">Exceptional Reviewer</font></strong>](https://leiwangr.github.io/files/ieee-access-reviewer.pdf)), CAAI Transactions on Intelligence Technology, Journal of Medical Internet Research (JMIR), Applied Soft Computing,
  * Neural Computing and Applications (NCAA), Image and Vision Computing, Journal of Visual Communication and Image Representation (JVCI), Signal, Image and Video Processing (SIVP), The Visual Computer (TVCJ), Computers & Graphics, Cognitive Robotics, Applied Computing and Informatics, SN Computer Science, Algorithms, Multimedia Systems, Machine Learning and Knowledge Extraction  (MAKE), Signal Processing: Image Communication, PLOS Digital Health, Nuclear Engineering and Technology, Physical Communication, International Journal of Clinical and Health Psychology (IJCHP), Bioengineering, International Journal of Human-Computer Interaction, Sensors, Electronics, Neural Networks, Intelligent Systems with Applications (ISWA), Displays, Journal of Imaging, Future Internet, Information, Healthcare, IET Computer Vision, Electronics Letters, AI Communications, Global Health Economics and Sustainability, PeerJ Computer Science, Computers, AI Computer Science and Robotics Technology (ACRT), Artificial Intelligence and Emerging Technologies (AIET)
 
* **Conferences**:
  * ICML 2026, AISTATS 2026, ICLR 2026, AAAI 2026, NeurIPS 2025, ICML 2025, AISTATS 2025, ICLR 2025, AAAI 2025, NeurIPS 2024, ICML 2024, ICLR 2024, AAAI 2024, NeurIPS 2023, ICML 2023, ICLR 2023, AAAI 2023, NeurIPS 2022, AAAI 2022, ICML 2022, 
