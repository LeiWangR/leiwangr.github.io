...
* **Journals**:
  * IEEE Transactions on Pattern Analysis and Machine Intelligence (TPAMI)([reviewer certificate](https://leiwangr.github.io/files/tpami-reviewer-certificate.pdf)), International Journal of Computer Vision (IJCV), IEEE Transactions on Image Processing (TIP), ACM Computing Surveys (ACM CSUR), 
  * IEEE Transactions on Circuits and Systems for Video Technology (TCSVT), IEEE Transactions on Industrial Informatics (TII), IEEE Transactions on Multimedia (T-MM), IEEE Transactions on Information Forensics and Security (TIFS), IEEE Transactions on Knowledge and Data Engineering (TKDE), Pattern Recognition (PR), TVCG, Big Data Mining and Analytics (BDMA), Computer Vision and Image Understanding (CVIU), Neurocomputing, ACM Transactions on Multimedia Computing, Communications, and Applications (TOMM), IEEE Signal Processing Letters, IEEE Access, CAAI Transactions on Intelligence Technology, Journal of Medical Internet Research (JMIR)
