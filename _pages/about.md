...
- 15/08/2025: Launching the <font color="green"><strong>TIME³</strong></font> vision: At the ARC Research Hub and Griffith University, <font color="green"><strong>TIME³</strong></font> Lab, evolving from the original Temporal Intelligence and Motion Extraction Lab, integrates three levels of AI research: Temporal Intelligence and Motion Extraction, Transformative Insights in Multi-faceted Evaluation, and Transparent, Inclusive, Measured, Ethical AI. The lab pioneers responsible, cross-disciplinary, and Green AI, advancing energy-efficient, trustworthy, and transformative artificial intelligence.
